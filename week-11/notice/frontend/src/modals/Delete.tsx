...
import { deleteNoticeApi, getCategoriesApi, getNoticesByCategoryApi } from '../util/api';

function Delete() {
  const { closeModal, notice, setFlashy, setNotices, setCategories, setCategory, categoryId } =
    useNotice();
