...
export const EVENT_ENDPOINTS = {
  ...
  EVENT_BY_ID: (id: number) => `${API_URL}/events/${id}`,
  ALL_INSTANCES_OF_EVENT: (eventId: number) =>
...
export const INSTANCE_ENDPOINTS = {
  INSTANCES_LOCATION: (city?: string) =>
    city
      ...
      : `${API_URL}/instances`,
  INSTANCE_BY_ID: (instanceId: number) =>
    `${API_URL}/events/instances/${instanceId}`,
  TICKET_TYPES_BY_INSTANCE_ID: (instanceId: number) =>
...
export const BOOKING_ENDPOINTS = {
  BOOK_TICKETS: (instanceId: number) =>
...
export const ORGANISER_ARTISTS_ENDPOINTS = {
  ...
  GET_ARTIST_BY_ID: (artistId: number) =>
    `${API_URL}/organiser/artists/${artistId}`,
  UPDATE_ARTIST: (artistId: number) =>
    `${API_URL}/organiser/artists/${artistId}`,
  DELETE_ARTIST: (artistId: number) =>
    `${API_URL}/organiser/artists/${artistId}`,
};
...
export const ORGANISER_VENUE_ENDPOINTS = {
  ...
  GET_VENUE_BY_ID: (venueId: number) => `${API_URL}/organiser/venue/${venueId}`,
  UPDATE_VENUE: (venueId: number) => `${API_URL}/organiser/venue/${venueId}`,
  DELETE_VENUE: (venueId: number) => `${API_URL}/organiser/venue/${venueId}`,
};

export const ORGANISER_EVENT_ENDPOINTS = {
  CREATE_EVENT: `${API_URL}/organiser/events`,
  GET_EVENTS: `${API_URL}/organiser/events`,
  GET_EVENT_BY_ID: (eventId: number) =>
    `${API_URL}/organiser/events/${eventId}`,
  UPDATE_EVENT: (eventId: number) => `${API_URL}/organiser/events/${eventId}`,
  DELETE_EVENT: (eventId: number) => `${API_URL}/organiser/events/${eventId}`,
};
